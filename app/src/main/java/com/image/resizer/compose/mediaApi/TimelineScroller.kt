...
fun <T : Media> TimelineScroller(
    ...
    InternalLazyVerticalGridScrollbar(
        ...
        indicatorContent = { index, isSelected ->
            ...
            val defaultDateFormat by remember { mutableStateOf(Constants.DEFAULT_DATE_FORMAT) }
            val weeklyDateFormat by remember { mutableStateOf(Constants.WEEKLY_DATE_FORMAT) }
            val extendedDateFormat by remember { mutableStateOf(Constants.EXTENDED_DATE_FORMAT) }
